        ...
        <main className={styles.main}>
          ...
          <div className={styles.painting}>
            ...
            <div className={styles.paintingItem}>
                <img src="/paintings/Untitled-(Yellow)-2022.jpg" alt="untitled yellow painting"className={styles.paintingImage} />
                <div className={styles.paintingText}>
                    <i>  Untitled (Yellow) </i> <br/>
                    <span className={styles.textYear}> 2022 </span>

                </div>
            </div>

            <div className={styles.paintingItem}>
                <img src="/paintings/Untitled-(Purple-and-Yellow)-2022.JPG" alt="untitled yellow painting"className={styles.paintingImage} />
                <div className={styles.paintingText}>
                    <i>  Untitled (Purple and Yellow) </i> <br/>
                    <span className={styles.textYear}> 2022 </span>
